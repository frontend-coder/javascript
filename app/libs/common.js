...
const tochVstavka = document.querySelector('.braike_title_span');
...
function changeing() {
  ...
  const newAsressImg = "https://cdn4.iconfinder.com/data/icons/hospital-19/512/14_hospital-128.png";
...
const myTextBold = 'Привет, я первая строка по Джаваскрипт';
let myTextBoldInTo = '';
...
const myTextTwo = document.getElementById('my_text_two').innerHTML;
const myTextTwoQuery = document.querySelector('#my_text_two').innerHTML;
...
const inputFirst = document.getElementById('input_first').innerHTML;
document.getElementById('my_text_two_two').innerHTML = inputFirst;



const innoyChild = '<i>4343</i>';
...
function help() {
  const firstFunc = 'Работает первая функция'
  document.querySelector('#invertFunc').innerHTML = `${firstFunc} - Вывод строки`;
}
help();


const btnFirsr = document.querySelector('#btn_firsr');
...
function letsgo() {
  const theFunc = 'действие при клике';
...
const manipNumber = 34;
const manipString = 'тридцать четыре';
...
const manipNumberTwo = 'тридцать четыре2';
const manipStringTwo = 'тридцать четыре';
const manip = document.querySelector('.manipul_srav2');
...
const colichPod = document.querySelector('.numberPodegd');
...
const claakaValue = document.querySelector('#claakaq23');
...
const inputNumber = document.querySelector('#number_past');
...
const blocksLabelInput = document.querySelector('.novytest');
...
const blocksLabelInputShirin = document.querySelector('.shirinnovytest');
...
const blocksLabelInputVisota = document.querySelector('.visotatest');
...
const novotestSubmit = document.querySelector('.novotest_submit');
...
function checkInput() {
  ...
  if (!isNaN(getDlinaAcvariuma) && !isNaN(getShirinaAcvariuma) && !isNaN(getVisotaAcvariuma)) {
    ...
    getDlinaAcvariuma /= 10;
    getShirinaAcvariuma /= 10;
    getVisotaAcvariuma /= 10;


    const getObem = getDlinaAcvariuma * getShirinaAcvariuma * getVisotaAcvariuma;
  ...
  const rezultGetNovotest = getNovotest * 4;
